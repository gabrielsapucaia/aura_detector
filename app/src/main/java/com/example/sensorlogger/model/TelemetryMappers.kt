...
object TelemetryMappers {
    ...
    data class GnssExtras(
        ...
        val rawSnapshot: GnssRawSnapshot? = null
    )
    ...
    fun fromLegacy(
        ...
        return TelemetryPayloadV11(
            ...
            gnssRaw = extras.gnss.rawSnapshot,
            ...
            accLongitudinalMps2 = imu.accLongitudinalMps2,
            accLateralMps2 = imu.accLateralMps2,
            accVerticalMps2 = imu.accVerticalMps2,
            vehicleTiltPitchDeg = imu.vehicleTiltPitchDeg,
            vehicleTiltRollDeg = imu.vehicleTiltRollDeg
        )
    }
