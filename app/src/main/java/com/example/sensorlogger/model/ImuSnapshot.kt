...
data class ImuSnapshot(
    ...
    val accLongitudinalMps2: Float? = null,
    val accLateralMps2: Float? = null,
    val accVerticalMps2: Float? = null,
    val vehicleTiltPitchDeg: Float? = null,
    val vehicleTiltRollDeg: Float? = null
) {
    companion object {
        val EMPTY = ImuSnapshot(
            ...
            accLongitudinalMps2 = null,
            accLateralMps2 = null,
            accVerticalMps2 = null,
            vehicleTiltPitchDeg = null,
            vehicleTiltRollDeg = null
        )
    }
}
