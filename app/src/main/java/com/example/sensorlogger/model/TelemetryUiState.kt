...
data class TelemetryUiState(
    ...
    val mqttStatus: String get() = when {
        localBrokerStatus == BrokerStatus.Connected || cloudBrokerStatus == BrokerStatus.Connected -> "Connected"
        localBrokerStatus == BrokerStatus.Connecting || cloudBrokerStatus == BrokerStatus.Connecting -> "Connecting"
        localBrokerStatus == BrokerStatus.Reconnecting || cloudBrokerStatus == BrokerStatus.Reconnecting -> "Reconnecting"
        else -> "Disconnected"
    }
